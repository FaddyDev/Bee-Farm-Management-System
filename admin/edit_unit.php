            ...
            <div class="row-fluid">
				<?php include('equipment_sidebar.php'); ?>
						...
						<div class="span7" id="content">
		                    <div class="row-fluid">
									 <a href="add_unit.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add equipment</a>
		                        <!-- block -->
		                        <div id="" class="block">
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" value="<?php echo $row['date']; ?>" class="span4" name="date" id="focusedInput" required>
											</div>
										</div>
										...
										$image = $_POST['image'];
										$date = $_POST['date'];
										$owner = $_POST['description'];
										
										
									
										mysql_query("update equipment set name = '$name' ,
																		...
																		date='$date',
																		owner='$owner'
																		where equipment_id = '$get_id' ")or die(mysql_error());
																		
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Euipment details of $name')")or die(mysql_error());
